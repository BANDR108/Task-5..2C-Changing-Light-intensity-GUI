...
ledRed = PWMLED(17) ## board pin 18
ledYellow = PWMLED(27) ## board pin 12
ledGreen = PWMLED(22) ## board pin 13
...
Label(win, text="Yellow LED", font=myfont, fg="yellow").grid(row=1, column=2)
yellow_slider = Scale(win, from_=0, to=1, resolution=0.01, orient=HORIZONTAL, command=lambda value: update_led(ledYellow, float(value)))
yellow_slider.grid(row=2, column=2)
